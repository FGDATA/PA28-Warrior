...
#    setprop("controls/switches/master-avionics", 0);
    ...
    setprop("systems/electrical/outputs/oat", 0.0);
setprop("systems/electrical/outputs/hsi", 13.7);
    setprop("systems/electrical/outputs/warning_lights_stall", 0.0);
...
avionics_bus_1 = func() {
    ...
    setprop("systems/electrical/outputs/comm[0]", bus_volts);
        if (bus_volts > vcutoff) {load += 0.8; }
    # OAT Power
    setprop("systems/electrical/outputs/oat", bus_volts);
        if (bus_volts > vcutoff) {load += 0.8; }
    # DME
